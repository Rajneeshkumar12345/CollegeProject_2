    ...
    <>
      <div className="placement py-5">
        <div className="container  container_placement square border border-5">
          <div className="col-md-12 text-white name py-5">
            <h3 className="text-center py-3" style={{backgroundColor:"#6e60cc"}}>  OUR{" "}
              <span
            ...
            <div className="table-responsive sectors_employing ">
              <table className="table table-bordered text-white " style={{backgroundColor:"rgba(112, 167, 176, 1)"}}>
                <tbody>
                  <tr className="info">
                    <td>Accenture</td>
            ...
            <div className="table-responsive sectors_employing">
              <table className="table table-bordered text-white " style={{backgroundColor:"rgba(90, 131, 181, 1)"}}>
                <tbody>
